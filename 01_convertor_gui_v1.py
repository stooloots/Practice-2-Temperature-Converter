...
class Converter:
    def __init__(self):
        ...
        instructions = "Please enter a temperature below and then press one of the buttons to convert it from centirgrade to Fahrenheit."
